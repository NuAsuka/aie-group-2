...
def report(
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Есть колонка, где все значение одинаковые: **{quality_flags['has_constant_columns']}**\n") # изменение для дз
        f.write(f"- Есть категариальный признак с очень большим числом уникальных значений: **{quality_flags['has_high_cardinality_categoricals']}**\n\n") # изменение для дз
